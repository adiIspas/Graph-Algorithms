...
queue<int> q, q_ar1, q_ar2, q_nod[100], q_nod2[100];
...
int main()
{
   ...
   if(s != 2*(n - 1))
    ...
    if(sw == 1)
        {
            for(i = strlen(codificare[0].c) - 1; i > 0; i--)
                cout << codificare[0].c[i];
            cout << codificare[0].c[0];
            k1 = 0;
        }
    else
        {
            for(i = strlen(codificare[lant[n/2 + 1]].c) - 1; i > 0; i--)
                cout << codificare[lant[n/2 + 1]].c[i];
            cout << codificare[lant[n/2 + 1]].c[0];
            k1 = lant[n/2 + 1];
        }
    cout << endl;
    ...
    if(sw == 1)
        ...
        {
            for(i = strlen(codificare2[lant[n/2 + 1]].c) - 1; i > 0; i--)
                cout << codificare2[lant[n/2 + 1]].c[i];
            cout << codificare2[lant[n/2 + 1]].c[0];
            k2 = lant[n/2 + 1];
        }
    cout << endl;
    ...
    for(i = 0; i < n1 ; i++)
    {
        cout << q_nod[x1].front() << " - > " << q_nod2[x2].front() << endl;
